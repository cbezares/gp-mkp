...
public class DelMinNormalized  extends GPNode {

private static final long serialVersionUID = -2534468225794857335L;
	
	public String toString() { return "Del_Min_Normalized"; }
	...
	public void eval(final EvolutionState state, final int thread,
		...
		//state.output.println("Terminal.eval: delMinNormalized", MKProblem.LOG_FILE);
		
		MKPData mkpd = (MKPData) input;
		
		//state.output.println("KS Antes:\t" + mkpd.getInstance().getKnapsack().toString(false), MKProblem.LOG_FILE);
		
		mkpd.setResult(MKP.delMinNormalized(mkpd.getInstance().getKnapsack()));
